...
-(void)drawProgressLabelCircleInRect:(CGRect)rect {
    ...
    CGContextAddArc(context, archXPos,archYPos, archRadius-2, progressStartAngle, progressEndAngle, clockWise);
    CGContextStrokePath(context);
    
    // Adding lines
    CGContextSetLineWidth(context,_backBorderWidth);
    CGContextMoveToPoint(context,rect.size.width/2, 0);
    CGContextAddLineToPoint(context,rect.size.width/2, _frontBorderWidth);
    CGContextStrokePath(context);
    
    CGContextSetLineWidth(context,_backBorderWidth);
    CGContextMoveToPoint(context,rect.size.width/2, rect.size.height);
    CGContextAddLineToPoint(context,rect.size.width/2, rect.size.height - _frontBorderWidth);
    CGContextStrokePath(context);
